            ...
            try:
                with open(label_path, 'r') as f:
                    for line in f:
                        ...
                        parts = line.split()
                        if len(parts) < 10:  # Expect class_idx + 8 coordinates
...
def main():
    ...
    labels_dir = r"D:\Ship_Detection_Data\Dataset_v5\labels" # Update to your labels folder
    classes_file = r"D:\Ship_Detection_Data\Dataset_v5\classes.txt"  # Update to your classes.txt path
