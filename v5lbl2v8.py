...
input_labels_dir = r"D:\ShipDetection\Combined4ClassDataset\V8LABELS\test\labels" # <--- CHANGE THIS
output_labels_dir = r"D:\ShipDetection\Combined4ClassDataset\V8LABELS\test\Letsee_test" # <--- CHANGE THIS
