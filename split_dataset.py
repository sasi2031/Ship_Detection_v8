...
# Define paths
image_input_dir = r"D:\Ship_Detection_Data_Sentinel2\Dataset_v8\images" # Replace with your image folder path
label_input_dir = r"D:\Ship_Detection_Data_Sentinel2\Dataset_v8\labels"  # Replace with your label folder path
output_dir = r"D:\Ship_Detection_Data_Sentinel2\Dataset_v8_split" # Replace with output directory for train/val folders
